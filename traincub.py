...
from torchmeta.datasets.helpers import cub 
from torchmeta.utils.data import BatchMetaDataLoader

from modelcubcnn import ConvolutionalNeuralNetwork
...
data_dir = 'cub'
dataset = cub(data_dir, shots=1, ways=5, shuffle=True, test_shots=15, meta_train=True, download=True) #data 
#dataset = cub(data_dir, shots=5, ways=5, shuffle=True, test_shots=15, meta_train=True, download=True) #data 
...
#Linear
###################for linear model only############
#model = LinearNeuralNetwork(7056, 5, hidden_size=32)
##################################################
